...
image_lable = Label(root, image=arrow_image, width=150)
...
text1 = Text(f, font="Robote", bg="white", relief=GROOVE, wrap=WORD)
...
text2 = Text(f1, font="Robote", bg="white", relief=GROOVE, wrap=WORD)
